...
import sys
sys.path.append("/home/pyliu/MPO-llama-adapters/models")
...
def llama_sequential(model, dataloader, dev):
    ...
    for i in range(len(layers)):
        ...
        if args.true_sequential:
            ...
            sequential = eval(args.target_modules)
        else:
...
if __name__ == '__main__':
    ...
    # my param
    parser.add_argument('--target_modules', type=str, default="[['self_attn.k_proj', 'self_attn.v_proj', 'self_attn.q_proj'], ['self_attn.o_proj'], ['mlp.up_proj', 'mlp.gate_proj'], ['mlp.down_proj']]")
